...
<head>
    ...
    <script>
        var arrayProveedores = <?php echo json_encode($_SESSION['arrayProveedores'], JSON_PRETTY_PRINT) ?>; 
            ...
            <div class="row">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <br>
                        <table id="proveedores" class="display" width="100%"></table>
                    </div>
                </div>
            </div>
            <!-- /.row -->
