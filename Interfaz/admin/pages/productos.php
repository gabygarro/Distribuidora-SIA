...
<head>
    ...
    <script>
        var arrayProductos2 = <?php echo json_encode($_SESSION['arrayProductos2'], JSON_PRETTY_PRINT) ?>; 

        $(document).ready(function() {
            $('#productos').DataTable( {
                data: arrayProductos2,
                columns: [
                    { title: "ID." },
                    { title: "Nombre" },
                    { title: "Descripción" },
            ...
            <div class="row">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <br>
                        <table id="productos" class="display" width="100%"></table>
                    </div>
                </div>
            </div>
            <!-- /.row -->
