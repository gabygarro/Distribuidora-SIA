...
<head>
    ...
    <![endif]-->
    <script>
        var arrayBodegas = <?php echo json_encode($_SESSION['arrayBodegas'], JSON_PRETTY_PRINT) ?>; 
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Bodegas</h1>
                </div>
                <!-- /.col-lg-12 -->
                <div class="panel panel-default">
                    <div class="panel-body">
                        <br>
                        <table id="bodegas" class="display" width="100%"></table>
                    </div>
                </div>
            </div>
            <!-- /.row -->
