...
<head>
    ...
    <script>
        var arrayCamiones = <?php echo json_encode($_SESSION['arrayCamiones'], JSON_PRETTY_PRINT) ?>; 
        ...
        $(document).ready(function() {
            $('#camiones').DataTable( {
                ...
                columns: [
                    ...
                    { title: "Combustible" },
                    { title: "Peso máx."},
                    { title: "Ubicación actual (Google Maps)" }
                ]
            } );
        } );
    </script>
            ...
            <div class="row">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <br>
                        <table id="camiones" class="display" width="100%"></table>
                    </div>
                </div>
            </div>
            <!-- /.row -->
